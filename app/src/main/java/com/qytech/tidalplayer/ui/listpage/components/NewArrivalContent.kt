...
@Composable
fun NewArrivalContent(
    navController: NavController
) {
    val viewModel: ListPageViewModel = hiltViewModel()
    val newArrivalPagingData = viewModel.newArrivalPagingData.collectAsLazyPagingItems()
    ...
    val checkLoadingCoroutine = rememberCoroutineScope()
        ...
        Column(
            ...
            for (index in 0..<dataList.itemCount) {
                ...
                item?.apply {
                    MixTracks(
                        subItem = item,
                        itemTracks = viewModel::getNewArrivalPagingData,
